        ...
        for email_id in email_ids:
            ...
            for response_part in msg_data:
                if isinstance(response_part, tuple):
                    ...
                    print(f"  Body length: {len(body)} chars", flush=True)
                    ...
                    reply_url_pattern = re.compile(r'https://[^\s<>"\']+(?:inreachlink\.com|garmin\.com)[^\s<>"\']+', re.IGNORECASE)
                    ...
                    # Nettoyer les caractères HTML éventuels
