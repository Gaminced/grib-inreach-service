# grib_handler.py - v3.1.0
"""Module de traitement des requêtes GRIB avec nettoyage email InReach"""
...
def process_grib_request(raw_email_body, inreach_url, reply_email=None):
    """
    ...
    """
    print(f"\n{'='*70}", flush=True)
    print(f"🌊 TRAITEMENT GRIB v3.1.0", flush=True)
    print(f"{'='*70}", flush=True)
